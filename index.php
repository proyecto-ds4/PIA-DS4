													...
													<footer class="panel-footer">
														<div class="row">
															<div class="col-md-12 text-right">
																...
																<button class="btn btn-primary" id="btnRegistrar" value="registrar" onclick="registrar()">Registrar</button>
															</div>
														</div>
													</footer>
												<!--</section>-->
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a class="btn btn-info" href="assets/php/delete.php?id=<?php echo $fila['expediente']; ?>" onclick="window.open(this.href, this.target, 'width=800,height=600'); return false;">Historial</a>
														<!--<button type="button" id="btnSalida" onclick="salida();" class="btn btn-success" value="<?php echo $fila['expediente']; ?>"> Prueba Salida</button>-->
